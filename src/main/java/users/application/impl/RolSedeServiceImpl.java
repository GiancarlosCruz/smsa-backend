...
@ApplicationScoped
public class RolSedeServiceImpl implements RolSedeService {

  private static final Logger LOG = Logger.getLogger(RolSedeServiceImpl.class);
  ...
  @Inject
  public RolSedeServiceImpl(UsuarioRepository usuarioRepository,
